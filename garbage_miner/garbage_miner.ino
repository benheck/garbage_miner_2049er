...
#define dontMove  0x80
#define falling	  0x80

//Bitwise defines for one-shot button presses
#define upBit		0x80
#define downBit		0x40
#define leftBit		0x20
...
//Actual data lengths: 458, 286, ....

uint8_t level = 1;						//Which game level we are on
uint16_t levelPointer = 0;				//The FLASH pointer of what we're reading

uint16_t levelSize[] = {0, 232, 278, 154, 247, 65535};	//Pointers to start of flash memory for all levels (use level-1 for this because of zero offset) 65535 = end of level data

const uint8_t levelData[] PROGMEM = {    //The built in levels data

0xF, 0x0, 0x2C, 0x0, 0x0, 0x0, 0x0, 0x0, 
0x21, 0x2, 0x41, 0x81, 0x41, 0x81, 0x41, 0x81, 0x41, 0x2, 0x15, 0x41, 0x1F, 0x1D, 0x2, 0x11, 0x41, 0x1, 0x41, 0x1, 0x41, 0x1, 0x41, 0x2, 0x13, 0x41, 0x11, 0x41, 0x1F, 0x1D, 0x1, 0x11, 0x1, 0x41, 0x51, 0x41, 0x51, 0x41, 0x51, 0x41, 0x2, 0x51, 0x12, 0x41, 0x11, 0x41, 0x1F, 0x1E, 0x2, 0x17, 0x2, 0x11, 0x92, 0x41, 0x11, 0x41, 0x1F, 0x1D, 0x44, 0x1, 0x41, 0x1, 0x41, 0x1, 0x41, 0x2, 0x44, 0x11, 0x41, 0x1F, 0x1D, 0x31, 0x12, 0x47, 0x52, 0x41, 0x14, 0x41, 0x1F, 0x1F, 0x14, 0x41, 0x15, 0x5, 0x51, 0x1F, 0x1F, 0x14, 0x41, 0x12, 0x41, 0x2, 0x45, 0x51, 0x4F, 0x4D, 0x16, 0x41, 0x12, 0x41, 0x18, 0x9, 0x11, 0x41, 0x11, 0x51, 0x13, 0x51, 0x1F, 0x12, 0x41, 0x12, 0x41, 0x12, 0x41, 0x13, 0x41, 0x1, 0x41, 0x9, 0x41, 0x1F, 0x18, 0x41, 0x12, 0x41, 0x12, 0x41, 
0x13, 0x41, 0x1, 0x41, 0x9, 0x41, 0x11, 0x1, 0x1F, 0x16, 0x41, 0x12, 0x41, 0x12, 0x41, 0x17, 0x8, 0x41, 0x11, 0x1, 0x1F, 0x16, 0x41, 0x12, 0x41, 0x12, 0x41, 0x18, 0x7, 0x41, 0x11, 0x1, 0x1F, 0x16, 0x41, 0x15, 0x41, 0x19, 0x6, 0x41, 0x11, 0x1, 0x1F, 0x16, 0x4F, 0x42, 0x8, 0x1F, 0x1F, 0x17, 0x47, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x11, 
...
uint8_t scratch[16];;			//Scratch line of RAM. Right now used for the edit menu
...
void setup() {
  ...
  /*
  	...
  	while(1) {
	  if (pressed(A_BUTTON)) {
		randomSeed(eventCounter);
		while(pressed(A_BUTTON)) {}
		break;
	  } 
	  eventCounter++;
	}
...
void gameLoop() {			//The main game loop
  ...
  switch(eventCounter++) {      //We divide up frame time by 8
	...
	case 4:						//Door animation state
		...
		if (gemsCollected >= gemsNeeded) {		//Ready to exit?
...
int eat(uint8_t x, uint8_t y, uint8_t dir) {            //When moving into a tile this processes what's there
...
void stripAttributes() {					//Removes the top 4 bits from all tiles on the map
...
int isValid(uint8_t x, uint8_t y) {
	...
	//Check for hero man death by explosion
...
void canSlimeGrow(uint8_t x, uint8_t y) {		//See if any cells above, below or to the side of slime are empty for growth
	...
	for (int x = 0 ; x < 4 ; x++) {					//Check all 4
	
		if (*ringPt[x] < 4) {						//Cell empty?
...
void walls() {			//Fills the map with standard walls and random dirt
